...
(1, 1, '2025-05-01 20:37:37', 'Active');
...
(33, 8, 'KOTEX Longer & Wider Scented Pantyliner 17.5cm (30s) - Odor Care with Daun Sirih Extract Liners', 'Enjoy extra comfort and confidence with Kotex Longer & Wider Scented Panty Liners 17.5cm.  These liners come with Daun Sirih Extract, offer light and breathable protection, so you stay fresh and dry every day!', 6.90, 1000, 'WTCMY-1000821-side-zoom.avif', 'WTCMY-1000821-front-zoom.avif', 'WTCMY-1000821-back-zoom.avif'),
(34, 8, 'CAREFREE Super Dry Shower Fresh Scent Liners 2x50s', 'Shaped for a natural and comfortable fit. Moisture proof backing for protection against leakage. Soft cover designed for dryness and comfort. Dermatologically tested against allergy and irritation', 18.90, 1000, 'WTCMY-41563-back-zoom.avif', 'WTCMY-41563-front-zoom.avif', 'WTCMY-41563-side-zoom.avif'),
(35, 9, 'DUREX Condom Close Fit 12s', 'Why You\'ll Love Durex Close Fit: Durability, Reliability, Excellence Since 1929. Size, Comfortable Fit, Small Size (Nominal Width: 49Mm). Latex Condoms With Regular Silicone Lube, Easy-On, Teat Ended Smooth Shape To Be Easier To Put On And Provide A Better Fit During Sex.', 39.90, 1000, 'WTCMY-11968-side-zoom.avif', 'WTCMY-11968-front-zoom.avif', 'WTCMY-11968-back-zoom.avif'),
(36, 9, 'ONE Extended Pleasures Condom 3\'s', 'ONE Extended Pleasures is the way to go for a good and long time. Softer latex condoms that features a lubricant with benzocaine, a mild male genital desensitizer, to help prevent premature ejaculation, extends performance time, and boosts self esteem in the bedroom. Safe, non prescriptive and improves premature ejaculation P.E. with repeated use.', 8.90, 1000, 'WTCMY-51194-front-zoom.avif', 'WTCMY-51194-back-zoom.avif', 'WTCMY-51194-alt1-zoom.avif'),
(37, 9, 'DUREX Condom Fetherlite Ultima Extra Thin 3s', 'Why You\'ll Love Durex Fetherlite Ultima, extra Thin For Enhanced Sensitivity, ofers Increased Sensitivity. Increasing The Feeling Of Closeness To Your Partner Without Sacrificing Safety. Sleek Fit And Feel.', 18.90, 1000, 'WTCMY-15483-side-zoom.avif', 'WTCMY-15483-front-zoom.avif', 'WTCMY-11968-back-zoom.avif'),
